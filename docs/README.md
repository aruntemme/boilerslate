...
| Page | What it covers |
| --- | --- |
| [Getting started](getting-started.md) | Setup, every command, making the repo yours |
...
`AGENTS.md` at the repo root is the instruction layer for AI coding agents —
the same conventions, written as operational rules rather than explanation.
